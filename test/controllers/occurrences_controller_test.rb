...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { data_begin: @occurrence.data_begin, description: @occurrence.description, status: @occurrence.status } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { data_begin: @occurrence.data_begin, description: @occurrence.description, status: @occurrence.status } }
